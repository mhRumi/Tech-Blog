  ...
  return (
    <Box w="100%" bg="gray.800" color="gray.50">
      <Center>
        ...
        >
          <Box p={3} m={2}>
            <Text fontSize="lg">{/*SWE Society*/}Tech Blog</Text>
            <Text fontSize="sm">
              ...
              15 November, 2016. */}
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia, praesentium perferendis quam repellendus laudantium iure quasi, nostrum quas commodi tempore ut minima eligendi molestias? Officia vitae deleniti culpa autem ut.
            </Text>
          </Box>
          <Spacer />
